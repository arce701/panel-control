...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - Styde.net</title>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(url('/profesiones')); ?>">Profesiones</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(url('/habilidades')); ?>">Habilidades</a>
                </li>
            </ul>
        </div>
    </nav>
...
</html><?php /**PATH D:\xampp\htdocs\panel\resources\views/layout.blade.php ENDPATH**/ ?>